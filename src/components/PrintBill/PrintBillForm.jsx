...
const PrintBillForm = props => {
    const {data,onClose,history,type} = props;
  ...
  return (
    ...
    {data && data.length===0 && <h4 style={{textAlign:"center"}}>No Checkouts Found in Specified Category</h4>}
    {data && data.length>0 && <TableContainer component={Paper} style={{marginTop:"0.7rem", maxHeight:"70vh"}}>
        <Table size="small" stickyHeader aria-label="sticky table">
            <TableHead>
                ...
                <TableCell style={{background:"#0088bc", color:"white"}} align="center">Total</TableCell>
            ...
            </TableHead>
            {
                data.map(el => {
                    ...
                    return(
                        ...
                        <TableCell align="center">{Number(el.totalAmount).toFixed(2)}</TableCell>
