...
const ExpectedCheckout = ({ allBookings, onClose, title, onSnackbarEvent, history, handleBookingselection }) => {
    ...
    const fetchBills = async()=>{
        setLoading(true)
        const res = await bookingService.getExpectedCheckouts()
        setLoading(false)
        if(res){
            setBills(res)
        }
...
export default withRouter(ExpectedCheckout);
